...
fig_save_dir = os.path.join(script_dir, 'analysis_plot')
...
for spacing_idx, pulse_spacing_us in tqdm(enumerate(pulse_spacing_us_list)):
    ...
    for temp_idx, temperature in enumerate(temperature_list):
        ...
        matrix_data_dir = os.path.join(os.path.join(script_dir, f'npz_data_base'), f'npz_data_base_{temperature}mK')
